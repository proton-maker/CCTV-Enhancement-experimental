...
For **upscale** (faces/plates), use [realesrgan](../realesrgan/SKILL.md) or Upscayl. For **generative face restore** on zoomed ROI, see [codeformer](../codeformer/SKILL.md). For full VRT (larger parallel model), see [vrt-video-restoration](../vrt-video-restoration/SKILL.md). For the **chained adaptive pipeline**, see [cctv-adaptive-pipeline](../cctv-adaptive-pipeline/SKILL.md).
